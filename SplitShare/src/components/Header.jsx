    ...
    <header className='py-6 mb-5 border-b ml-10 mr-10'>
      <div className='container mx-auto flex justify-between items-center'>
        ...
        <div className='flex items-center gap-6'>
          ...
          <Link className='hover:text-orange-700 text-white transition' to='/contact'>Add new Property</Link>
          <Link className='hover:text-orange-700 text-white transition' to='/login'>Log In</Link>
          <Link className='bg-orange-500 hover:bg-orange-600 text-white px-4 py-3 rounded-lg transition' to='/login'>Sign Up</Link>
        </div>
      </div>
    </header>
  );
